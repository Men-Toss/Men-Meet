...
-- **************************** SqlDBM: MySQL ***************************
-- ****** Generated by SqlDBM: Men_Meet, v17 by asdf74591@gmail.com *****
...
PRIMARY KEY (`Alert_ID`, `Alert_Count`),
KEY `FK_197` (`Alert_ID`),
CONSTRAINT `FK_195` FOREIGN KEY `FK_197` (`Alert_ID`) REFERENCES `Men_Meet_Schema`.`User_Table` (`User_ID`)
);
